            ...
            if (msg.what == Constants.GET_PARTICULAR_COURSE) {
                ...
                if (command.success) {
                    ...
                    for (int i=0;i<particularCourseBodyVo.getCourse().getTeacherList().size();i++) {
                        if (particularCourseBodyVo.getCourse().getTeacherList().get(i).getName() == "null" || particularCourseBodyVo.getCourse().getTeacherList().get(i).getName().equals(null)){
                            return;
                        }else{
                            if (teacherName == null) {
                                teacherName = particularCourseBodyVo.getCourse().getTeacherList().get(i).getName() + "、";
                            }else{
                                teacherName = teacherName + particularCourseBodyVo.getCourse().getTeacherList().get(i).getName() + "、";
                            }
                        }
                    }
